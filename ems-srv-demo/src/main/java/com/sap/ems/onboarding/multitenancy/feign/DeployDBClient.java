  ...
  * @since 
  */
  package com.sap.ems.onboarding.multitenancy.feign;
...
import com.sap.ems.conf.DepolyDBClientFeignConfig;

/**
  * ClassName: DeployDBClient <br/><br/> 
  * Description: DeployDBClient
  * @author SAP
  * @version 
  * @see
  * @since 
  * https://srv-ems-dynamic-db-demo.cfapps.sap.hana.ondemand.com
  * https://ems-dynamic-db-perf.cfapps.sap.hana.ondemand.com
  */
@FeignClient( name = "dbClient" ,url = "https://srv-ems-dynamic-db-demo.cfapps.sap.hana.ondemand.com", configuration = DepolyDBClientFeignConfig.class)
public interface DeployDBClient
{
    
     /**
      * Title: deployDB <br/><br/>  
